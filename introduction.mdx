...
The Greip Fraud Prevention API can be used for both personal and commercial use cases. New accounts start with a **3-day free trial** on Standard or Premium (card required, 1,000 API requests during the trial). After the trial, the full plan quota applies. To get started, [create an account](https://dashboard.greip.io/register?src=docs/introduction) and obtain a unique API key. Once you have your key and an active trial or paid plan, you can use it to access the API's functions and start detecting and preventing fraud in your website or app.
